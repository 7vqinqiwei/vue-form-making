<template>
  <el-container class="fm2-container">
    ...
    <el-footer height="30px" style="font-weight: 600;">Powered by <a target="_blank" href="https://github.com/7vqinqiwei/vue-form-making">vue-form-making</a></el-footer>
  </el-container>
...
export default {
  ...
  methods: {
    ...
    handleGoGithub () {
      window.location.href = 'https://github.com/7vqinqiwei/vue-form-making'
    },
